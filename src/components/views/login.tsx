...
const GoogleIcon = () => (
  ...
  >
    <path
      fill="currentColor"
      d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 126 21.2 172.4 60.3l-66.8 64.2c-20-17.7-48.8-30.8-79.6-30.8-62.3 0-113.6 51.3-113.6 114.3s51.3 114.3 113.6 114.3c71.4 0 98.1-49.3 102.3-73.4H248v-85.3h236.1c2.3 12.7 3.9 26.9 3.9 41.4z"
    ></path>
  </svg>
);
const LinkedInIcon = () => (
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          onClick={() =>
                            toast({
                              title: 'Coming Soon!',
                              description: 'Password recovery is on its way.',
                            })
                          }
