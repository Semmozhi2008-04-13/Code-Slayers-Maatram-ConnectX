...
// IMPORTANT: The 'id' fields are now simple placeholders.
// The seeding script will generate the actual Firestore document IDs.
...
export const dummyJobs: Omit<Job, 'id'>[] = [
  {
...
export const dummyEvents: Omit<Event, 'id'>[] = [
  {
...
export const dummyPosts: Omit<Post, 'id' | 'author' | 'createdAt'>[] = [
  {
